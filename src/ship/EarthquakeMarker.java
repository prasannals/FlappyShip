...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker){
		 Float iOne =  Float.parseFloat( this.getProperties().get("magnitude").toString() );
		 Float iTwo =  Float.parseFloat( marker.getProperties().get("magnitude").toString() );
		 return Float.compare(iTwo, iOne);
	}
